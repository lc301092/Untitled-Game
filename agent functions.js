...
function PrintState() {
	...
	console.log(this.drawPile.length + ' cards in draw pile. \n' + this.discardPile.length + ' cards in discard pile: ' + this.discardPile +'\n'+'status: ' + this.cardSum);
	console.log('------------------------------------');
...
function Stand() {
	console.log('you stand at: ' + this.cardSum);
	this.cardSum = 0;
}
